...
def get_event_listeners(
    ...
    :param pierce: *(Optional)* Whether or not iframes and shadow roots should be traversed when returning the subtree (default is false). Results listeners for all contexts if pierce is enabled.
